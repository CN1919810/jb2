...
local Window = OrionLib:MakeWindow({Name = "司马脚本", HidePremium = false, SaveConfig = false, IntroText = "注入器："..identifyexecutor(), ConfigFolder = "司马脚本"})
